...
Facebook Authentication, Google OAuth y Twitter OAuth
...
En principio, todos los Datos solicitados por esta Aplicación son obligatorios y la negativa a proporcionarlos podrá hacer que esta Aplicación se vea en la imposibilidad de prestar sus servicios. En los casos en los que esta Aplicación indique específicamente que ciertos Datos no son obligatorios, los Usuarios serán libres de no comunicar tales Datos sin que esto tenga consecuencia alguna sobre la disponibilidad o el funcionamiento del servicio.
...
###### Acceso a la cuenta de Facebook (Facebook, Inc.)
Este servicio permite a esta Aplicación conectarse con la cuenta del Usuario en la red social Facebook, proporcionada por Facebook, Inc.
Permisos solicitados: Dirección de correo electrónico, Información básica, Fotografías.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.facebook.com/policy.php)

###### Acceso a la cuenta de Twitter (Twitter, Inc.)
Este servicio permite a esta Aplicación conectarsecon la cuenta del Usuario en la red social Twitter, proporcionada por Twitter, Inc.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://twitter.com/privacy)
</details>
...
Datos Personales recogidos: apellido(s), dirección de correo electrónico, nombre.
</details>
...
Google Analytics for Firebase o Firebase Analytics es un servicio de estadísticas prestado por Google Inc. Para saber más sobre cómo usa Google los Datos puede consultar [la Política de Partners de Google](https://www.google.com/intl/it/policies/privacy/partners/).
Firebase Analytics podrá compartir Datos con otras herramientas proporcionadas por Firebase, tales como Crash Reporting, Remote Config o Notifications. Los Usuarios pueden revisar la presente política de privacidad para obtener una explicación detallada sobre las demás herramientas que emplea el Titular.
Esta Aplicación utiliza tecnologías similares a las cookies para hacer funcionar el servicio Firebase Analytics.
...
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)
</details>
...
Firebase Cloud Messaging es un servicio de envío de mensajes prestado por Google Inc. Firebase Cloud Messaging permite al Titular enviar mensajes y notificaciones a los Usuarios a través de diversas plataformas, tales como Android, iOS e Internet. Los mensajes se pueden enviar a dispositivos individuales, a grupos de dispositivos o a segmentos específicos según temáticas o Usuarios.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)

###### Firebase Notifications (Google Inc.)
Firebase Notifications es un servicio de envío de mensajes prestado por Google Inc. Firebase Notifications puede integrarse con Firebase Analytics para dirigirse a audiencias seleccionadas en base a estadísticas y monitorizar los eventos de apertura y conversión.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)
</details>
...
Firebase Cloud Storage es un servicio de hosting prestado por Google Inc.
Datos Personales recogidos: Datos de Uso y distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)

###### Firebase Hosting (Firebase, Inc.)
Firebase Hosting es un servicio de hosting prestado por Google Inc.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)

###### Firebase Realtime Database (Google Inc.)
Firebase Realtime Database es un servicio de hosting y backend prestado por Google Inc.
Datos Personales recogidos: Datos de Uso y distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)

###### Firebase Cloud Functions (Google Inc.)
Firebase Cloud Functions es un servicio de hosting y backend prestado por Google Inc.
Datos Personales recogidos: Datos de Uso y distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)
</details>
...
Las interacciones y la información obtenida por esta Aplicación siempre estarán sometidas a la configuración de privacidad del Usuario en cada red social.
...
###### Botón “Me gusta” y widgets sociales de Facebook (Facebook, Inc.)
...
Datos Personales recogidos: Cookie y Datos de Uso.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.facebook.com/privacy/explanation)

###### Botón Tweet y widgets sociales de Twitter (Twitter, Inc.)
El botón Tweet y los widgets sociales de Twitter son servicios de interacción con la red social Twitter, prestados por Twitter, Inc.
Datos Personales recogidos: Cookie y Datos de Uso.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://twitter.com/privacy)
</details>
...
Firebase Crash Reporting es un servicio de monitorización de aplicaciones prestado por Google, Inc.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)

###### Firebase Performance Monitoring (Google Inc.)
Firebase Performance Monitoring es un servicio de monitorización de aplicaciones prestado por Google, Inc.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)
</details>
...
Datos Personales recogidos: Permiso de almacenamiento, Permiso para la cámara.
</details>
...
Algunos de los servicios indicados más abajo pueden emplear Cookies para identificar a los Usuarios o pueden utilizar la técnica del behavioral retargeting, es decir mostrar anuncios publicitarios personalizados en base a los intereses y al comportamiento del Usuario, inclusive aquellos que hayan sido obtenidos fuera de esta Aplicación. Para obtener más información, por favor verifique las políticas de privacidad de los servicios correspondientes.
Además de cualquier opción de “opt out” ofrecida por cualquiera de los servicios que se indican a continuación, el Usuario también puede optar por la exclusión del uso de cookies por servicios de terceros accediendo a la [página de exclusión de Network Advertising Initiative](http://optout.networkadvertising.org/), [youronlinechoices.eu](www.youronlinechoices.eu) y/o [aboutads](www.aboutads.info/choices/).

###### Google AdSense (Google Inc.)
Google AdSense es un servicio de publicidad prestado por Google Inc. Este servicio utiliza la Cookie “Doubleclick”, que rastrea el uso de esta Aplicación y el comportamiento del Usuario en relación con los anuncios publicitarios, productos y servicios ofertados.
Los Usuarios podrán decidir en cualquier momento desactivar todas las Cookies Doubleclick clicando en: google.com/settings/ads/onweb/optout.
Datos Personales recogidos: Cookie y Datos de Uso.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/policies/technologies/ads/) – [Opt Out](https://www.google.com/settings/ads/onweb/optout?hl=es)

###### AdMob (AdMob Google Inc.)
AdMob es un servicio de publicidad prestado por AdMob Google Inc.
Para saber más sobre cómo usa Google los Datos puede consultar [la Política de Partners de Google](https://www.google.com/intl/es/policies/privacy/partners/).
Datos Personales recogidos: Cookie, Datos de Uso y identificadores únicos de dispositivo para publicidad (ID de publicidad de Google o IDFA, por ejemplo).
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/policies/technologies/ads/) – [Opt Out](https://www.google.com/settings/ads/)

###### Appodeal (Appodeal, Inc)
Appodeal es una plataforma de mediación de anuncios publicitarios cuyos servicios son prestados por Appodeal, Inc. Este servicio podría rastrear el uso de esta Aplicación y el comportamiento del Usuario en relación con los anuncios publicitarios, productos y servicios ofertados.
Los Usuarios podrán decidir en cualquier momento desactivar estas características en: https://tools.google.com/dlpage/gaoptout y https://yandex.com/support/metrica/general/opt-out.xml
Datos Personales recogidos: Cookie, Datos de Uso e identificadores únicos de dispositivo para publicidad (ID de publicidad de Google o IDFA, por ejemplo).
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.appodeal.com/privacy-policy) – [Opt out](https://www.appodeal.com/sdk_opt_out)
</details>
...
Algunos de estos servicios también pueden permitir el envío de mensajes programados al Usuario , como correos electrónicos con facturas adjuntas u otras notificaciones relativas al pago.

###### Google Pay (Google Inc.)
Google Pay es un servicio de pagos prestado por Google LLC o por Google Ireland Limited, dependiendo del lugar desde donde se accede a esta Aplicación,, que permite a los Usuarios realizar pagos online utilizando sus credenciales de Google.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.

Lugar de tratamiento: EE.UU. – [Política de privacidad](https://wallet.google.com/files/privacy.html?hl=es). Integrante del acuerdo „Privacy Shield”.

Categoría de datos personales recogidos con arreglo a la CCPA: internet information.

###### Android Pay (Google Inc.)
Android Pay es un servicio de pagos prestado por Google Inc., que permite a los Usuarios realizar pagos usando sus teléfonos móviles.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.

Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/policies/privacy/).
...
Firebase Authentication es un servicio de registro y autenticación prestado por Google Inc. Para simplificar el proceso de registro y autenticación, Firebase Authentication puede usar proveedores de identidad de terceros y guardar la información en su plataforma.
Datos Personales recogidos: apellido(s), cuentas en redes sociales, dirección de correo electrónico, foto de perfil, nombre, password y username.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)

###### Facebook Authentication (Facebook, Inc.)
Facebook Authentication es un servicio de registro y autenticación prestado por Facebook, Inc. y conectado a la red social Facebook.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.facebook.com/help/405977429438260)

###### Google OAuth (Google Inc.)
Google OAuth es un servicio de registro y autenticación prestado por Google Inc. y conectado a la red Google.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/policies/privacy/)

###### Twitter OAuth (Twitter, Inc.)
Twitter OAuth es un servicio de registro y autenticación prestado por Twitter Inc. y conectado a la red Twitter.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://twitter.com/privacy)
</details>
...
Firebase Remote Config es un servicio de A/B testing y configuración prestado por Google Inc.
Datos Personales recogidos: distintas clases de Datos, según se especifica en la Política de Privacidad del servicio.
Lugar de tratamiento: EE.UU. – [Política de privacidad](https://www.google.com/intl/es/policies/privacy/)
</details>
