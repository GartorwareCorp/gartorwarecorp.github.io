...
Se informa a los Usuarios de que el Titular puede publicar la totalidad o parte de la contribución en cuestión de forma pública en el sitio web de Open Food Facts (openfoodfacts.org).
...
En particular, la información y fotografías de algunos productos puede proceder de Open Food Facts (openfoodfacts.org). El Titular no controla ni modera este contenido mostrado a través de esta Aplicación.
...
Los Usuarios podrán descargar, instalar, utilizar y ejecutar el software en un único dispositivo.
...
_*A la atención de:_

_Gartorware_  
_gartorware@gmail.com_

_Yo, comunico mi intención de desistir de nuestro contrato de compraventa para la prestación del siguiente servicio:_.

______________________________________________ (insertar una descripción de los servicios a los que se refiere el desistimiento correspondiente)_

*   _Pedido el: _____________________________________________ (inserte la fecha)_
*   _Recibido el: _____________________________________________ (inserte la fecha)_
*   _Nombre del consumidor:______________________________________________
*   _Dirección del consumidor:______________________________________________
*   _Correo electrónico del consumidor:______________________________________________
*   _Fecha: ______________________________________________

_(firmar si se comunica este formulario en formato impreso)_
...
Un activo no monetario mediante el cual los Usuarios puedan comprar Productos específicos ofrecidos en esta Aplicación con arreglo a las condiciones establecidas por el Titular. Dichos activos pueden manifestarse en forma de códigos, fichas, imágenes digitales, etc.
